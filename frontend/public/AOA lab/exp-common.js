/* ============================================================
   exp-common.js
   Shared logic for every AOA Lab experiment detail page.
   ...
   Expected expConfig shape:
   {
     ...
     title: "Quick Sort Method",      // shown as "Experiment N: <title>"
     files: {
       aim: "aim1.c.txt",
       code: "exp1.c",
       output: "output1.c.txt",
...
(function () {
          ...
          <div class="exp-content">
            ...
            <div id="content-code" class="tab-pane" style="display:none;">
              <div class="code-container">
                ...
                <button class="action-btn download-c-btn" onclick="downloadCode('c')">Download .c</button>
  ...
  window.downloadCode = function (ext) {
    ...
    const btn = document.querySelector(`.download-${ext}-btn`);
    const originalLabel = ext === 'c' ? 'Download .c' : 'Download .txt';
