  ...
  return (
    <div className="sl-home min-h-screen text-[#0f172a] font-sans relative overflow-x-hidden">
      ...
      <div className="sl-shell">
        ...
        {/* QUICKPASTE TOOL SECTION */}
        <section className="sl-section scroll-anchor" style={{ marginTop: "40px", marginBottom: "0" }}>
          <div style={{
            background: "linear-gradient(135deg, #0f0c29 0%, #1a1a4e 50%, #302b63 100%)",
            borderRadius: "20px",
            padding: "40px 32px",
            border: "1px solid rgba(99,102,241,0.2)",
            boxShadow: "0 0 0 1px rgba(255,255,255,0.03), 0 24px 60px rgba(0,0,0,0.4)",
            position: "relative",
            overflow: "hidden",
          }}>
            {/* Background glow */}
              ...
              <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", flexWrap: "wrap", gap: "24px" }}>
                ...
                <div style={{ flex: "1", minWidth: "240px" }}>
                  ...
                  <h3 style={{
                    ...
                    color: "#fff", margin: "0 0 10px", letterSpacing: "-0.02em", lineHeight: 1.2,
                  }}>
                    QuickPaste
                    <span style={{
                      ...
                      borderRadius: "100px", verticalAlign: "middle", letterSpacing: "0.04em",
                    }}>
                      FREE
                    </span>
                  </h3>
                  <p style={{ fontSize: "14px", color: "rgba(255,255,255,0.65)", margin: "0 0 20px", lineHeight: 1.65, maxWidth: "420px" }}>
                    Paste any text — notes, code, answers, anything — and get a{" "}
                    <strong style={{ color: "rgba(255,255,255,0.85)" }}>short memorable link</strong>{" "}
                    instantly. No login required. Share it anywhere.
                  </p>
                  <div style={{ display: "flex", flexWrap: "wrap", gap: "10px", marginBottom: "24px" }}>
                    {[
                      { icon: "🔗", text: "Memorable links" },
                      { icon: "🔒", text: "No login needed" },
                      { icon: "📐", text: "Exact formatting" },
                ...
                <div style={{
                  background: "rgba(10,13,20,0.7)", border: "1px solid rgba(99,102,241,0.2)",
                  borderRadius: "14px", padding: "16px", minWidth: "220px", maxWidth: "280px",
                  ...
                  <div style={{ display: "flex", alignItems: "center", gap: "6px", marginBottom: "10px" }}>
                    ...
                    <span style={{ marginLeft: "8px", fontSize: "11px", color: "#475569", fontFamily: "monospace" }}>new-paste.txt</span>
                  </div>
                  <div style={{ fontFamily: "monospace", fontSize: "12px", color: "#94a3b8", lineHeight: 1.6, marginBottom: "12px" }}>
                    <div style={{ color: "#6ee7b7" }}>Dear team,</div>
                    <div>Meeting at 3PM today.</div>
                    <div>Agenda:</div>
                    <div style={{ paddingLeft: "12px", color: "#a5b4fc" }}>1. Project review</div>
                    <div style={{ paddingLeft: "12px", color: "#a5b4fc" }}>2. Deadlines</div>
                    <div style={{ color: "#94a3b8", marginTop: "4px" }}>Thanks!</div>
                  </div>
                  <div style={{
                    ...
                    <span style={{ fontFamily: "monospace", fontSize: "11px", color: "#818cf8" }}>
                      /p/swift-tiger-07
                    </span>
                    <span style={{
